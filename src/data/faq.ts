export const faqData = [
  {
    ...
    a: "Гнучкість та фокус на результаті. Ми не підлаштовуємо ваш бізнес під можливості програми, а навпаки — адаптуємо інструменти під ваші звичаї. Це створення живої архітектури, яка працює на вас, поки ви фокусуєтесь на стратегії.",
  },
  {
    q: "Що, якщо мій бізнес занадто специфічний і тримається на «особистій магії»?",
    a: "Саме тому проєкт називається ЗВИЧАЇКА. Ми не насаджуємо шаблонні процеси. Якщо ваш успіх базується на особистих зв'язках — ми опішемо систему підтримки цих зв'язків. Будь-яка «магія», що приносить гроші, має свій алгоритм. Ми знайдемо його і зафіксуємо, щоб результативність не залежала від настрою чи пам'яті окремих людей.",
  },
  {
  ...
  },
  {
    ...
    a: "Все залежить від масштабу:\n\nПорядок на вчора: 1-2 тижні.\n\nКорпоративна культура та ШІ: 3–5 тижнів.\n\nЦифровий мозок компанії: 2–3 місяці.",
  },
  {
  ...
  },
  {
    ...
    a: "Зовсім ні. Хоча пакети сформовані для комплексного вирішення задач, ЗВИЧАЇКА — це передусім про доцільність. Ми можемо зайти в проєкт точково, щоб вирішити конкретний «біль»:\n\nМіграція: Наприклад, якщо ви хочете переїхати з однієї таск-менеджмент системи в іншу (з Trello в Asana чи Notion) без втрати даних та нервів команди.\n\nСистематизація: Якщо потрібно просто перетворити хаос із файлів на Google Диску на логічну, структуровану базу даних, де кожен документ має своє місце.\n\nОкремий процес: Описати лише один складний вузол (наприклад, найм або обробку замовлень).",
  },
];

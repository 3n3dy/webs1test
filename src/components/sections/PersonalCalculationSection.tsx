...
export const PersonalCalculationSection = memo(() => {
  ...
  const services = [
    [
      { title: 'Wiki-бази, Notion, ClickUp', desc: 'Створення та налаштування систем управління', price: '350 грн/год' },
      { title: 'Бізнес-процеси та SOPs', desc: 'Опис та формування інструкцій і процедур', price: '350 грн/год' },
      { title: 'Автоматизація та AI', desc: 'Інтеграція з CRM та AI-рішеннями', price: '400 грн/год' },
    ],
    [
      { title: 'Операційний менеджер "на день"', desc: 'Аналіз та виконання операційних задач', price: '3500 грн/день (8 год)' },
      { title: 'Онбординг співробітників', desc: 'Супровід бізнесу в адаптації персоналу', price: '438 грн/год' },
      { title: 'Міграція між системами', desc: 'Trello → Asana, Notion без втрати даних', price: '350 грн/год' },
    ],
    [
      { title: 'Систематизація Google Drive', desc: 'Структурована база з хаосу файлів', price: '350 грн/год' },
      { title: 'Документування процесу', desc: 'Найм персоналу, обробка замовлень тощо', price: '350 грн/год' },
    ]
  ];
        ...
        <div className="px-8">
          <div className="space-y-2">
            {services[currentSlide].map((service, idx) => (
              <div key={idx} className="bg-white/10 rounded-lg p-2.5 hover:bg-white/20 transition-all">
                <p className="font-semibold text-sm">{service.title}</p>
                <p className="text-white/90 text-xs mt-0.5">{service.desc}</p>
                <p className="text-yellow-300 font-bold text-xs mt-1">→ {service.price}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          {!isFlipped && (
            <>
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <a href="viber://chat?number=380950571649" className="w-14 h-14 bg-white rounded-full flex items-center justify-center hover:shadow-lg hover:scale-110 transition-all shadow-md">
                  <img alt="Viber" className="w-8 h-8" src="https://img.icons8.com/color/48/viber.png" />
                </a>
                <a href="https://www.facebook.com/profile.php?id=61571510310773" target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-white rounded-full flex items-center justify-center hover:shadow-lg hover:scale-110 transition-all shadow-md">
                  <img alt="Facebook" className="w-8 h-8" src="https://img.icons8.com/color/48/facebook-new.png" />
                </a>
                <a href="https://www.linkedin.com/in/hanna-marchak-90b642344/" target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-white rounded-full flex items-center justify-center hover:shadow-lg hover:scale-110 transition-all shadow-md">
                  <img alt="LinkedIn" className="w-8 h-8" src="https://img.icons8.com/color/48/linkedin.png" />
                </a>
                <a href="tel:+380950571649" className="w-14 h-14 bg-white rounded-full flex items-center justify-center hover:shadow-lg hover:scale-110 transition-all shadow-md">

    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          >
            {/* Sticky Header */}
            <div className="flex-shrink-0 text-white bg-gradient-to-r from-purple-600 to-pink-600 p-6 rounded-t-3xl flex items-center justify-between">              <Dialog.Title className="text-3xl font-semibold flex items-center gap-3">
          ...
          Інформація про автора - Ганну Марчак, спеціалістку з управління знаннями
            ...
            {/* Content */}
              ...
              <section>
                ...
                <p className="text-gray-700 mb-4">
                  <i>Я фанат автоматизації, але тільки тієї, що полегшує життя.</i>
                </p>

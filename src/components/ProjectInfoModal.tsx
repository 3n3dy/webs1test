...
import {
  X, Zap, Rocket, CheckCircle, HeartHandshake,
  BookOpen, FileCog, Workflow, CloudUpload, Fingerprint,
} from "lucide-react";
    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          >
            {/* Header */}
            <div className="flex-shrink-0 bg-gradient-to-r from-purple-600 to-pink-600 text-white p-4 md:p-6 rounded-t-3xl flex items-center justify-between">
            ...
            {/* Увесь контент + footer — скролиться разом */}
            <div className="overflow-y-auto flex-1 p-4 md:p-8 space-y-6 text-gray-700 leading-relaxed">
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={idx} className="flex items-start gap-3">
                      ...
                      <span className="text-sm md:text-base break-words">{item.text}</span>
                    </li>
                  ))}
                </ul>
              </section>
                    ...
                    return (
                      <div
                        ...
                        className={`relative bg-white rounded-xl border transition-all duration-300 overflow-hidden cursor-pointer min-h-[120px] z-0 ${
                          isActive ? "border-transparent shadow-2xl" : "border-gray-200 hover:shadow-lg"
                        }`}
                      >
                        <div
                        ...
                        <div className="relative z-10 p-4 md:p-6">
                          <div className="flex justify-center mb-3">
                            <div className={`transition-all duration-300 ${isActive ? "text-white scale-110" : "text-purple-600"}`}>
              ...
              {/* Footer — всередині скролу */}
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 md:p-6 rounded-2xl text-center border border-purple-200">
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="flex items-center justify-center gap-3">
                    <a href="https://www.facebook.com/profile.php?id=61587463958698" target="_blank" rel="noreferrer" className="hover:scale-110 transition-transform" title="Facebook">
                      <img alt="Facebook" className="w-8 h-8" src="https://img.icons8.com/color/48/facebook-new.png" />
                    </a>
                    <a href="https://www.linkedin.com/company/zvychaika" target="_blank" rel="noreferrer" className="hover:scale-110 transition-transform" title="LinkedIn">
                      <img alt="LinkedIn" className="w-8 h-8" src="https://img.icons8.com/color/48/linkedin.png" />
                    </a>
                    <a href="tel:+380950571649" className="hover:scale-110 transition-transform">

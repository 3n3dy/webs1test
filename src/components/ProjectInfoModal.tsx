  ...
  const cards = [
    {
      ...
      description:
        "Чітка оргструктура, зрозумілі ролі та KPI, що забезпечують прозорість процесів і звільняють власника від операційних дрібниць.",
    ...
    },
    {
      ...
      description:
        "Єдині стандарти якості, автоматизація та регламентація завдань мінімізують помилки й гарантують прогнозований результат.",
    ...
    },
    {
      ...
      description:
        "Знання зберігаються у цифровій базі, незалежні від персоналу, що забезпечує стійкість бізнесу та швидку адаптацію нових співробітників.",
    ...
    },
    {
      ...
      description:
        "KPI та регулярна звітність дозволяють управляти бізнесом на основі цифр, бачити вузькі місця й приймати рішення без припущень.",
    ...
    },
    {
      ...
      description:
        "Бізнес стає готовим до масштабування та відкриття нових точок. Порядок у справах робить компанію привабливим активом для капіталізації.",
      gradient: "from-purple-400 to-purple-500",
    },
    {
      ...
      description:
        "Інтеграції між системами, автоматичні workflow та «Книга Новачка» скорочують час онбордингу й підвищують продуктивність команди.",
      gradient: "from-violet-400 to-violet-500",
    },
  ];

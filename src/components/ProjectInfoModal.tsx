            ...
            <div className="p-4 md:p-8 space-y-6 text-gray-700 leading-relaxed">
              <section>
                ...
                <p className="text-sm md:text-base">
                  Проєкт базується на поєднанні глибокого розуміння внутрішніх процесів («звичаїв») із наданням власнику свободи для стратегічного розвитку («чай»).
                </p>
                ...
                <p className="mt-3 text-sm md:text-base">
                  Проєкт пропонує перехід від «ручного управління» до автономної системи через впровадження таких інструментів, як Wiki-системи (Notion, Confluence, Slab), оргсхеми з чіткими зонами відповідальності та «Книги Новачка» для автоматизованої адаптації.
                </p>
              </section>
